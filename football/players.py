...
class Player:
    '''Dosctring
    THIS IS A VERY GENERALIZABLE MODEL IF YOU KNOW THINGS ABOUT FOOTBALL
    and that's okay
    '''
...
class Defensive(Player):
    ...
    '''
    def __init__(self, name=None, yards=10, touchdowns=1, tackles=5, sacks = 1,
                 interceptions=1, safety=None, field_goals=None):
        super().__init__(name=name, yards=yards, touchdowns=touchdowns, tackles=tackles, 
                         sacks=sacks, safety=safety, interceptions=interceptions)
